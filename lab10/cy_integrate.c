...
#define __PYX_HAVE__cy_integrate
#define __PYX_HAVE_API__cy_integrate
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "cy_integrate" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "cy_integrate"
extern int __pyx_module_is_main_cy_integrate;
int __pyx_module_is_main_cy_integrate = 0;

/* Implementation of "cy_integrate" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_12cy_integrate_integrate_any(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_f, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter); /* proto */
...
#define __pyx_kp_u_cy_integrate_pyx __pyx_string_tab[1]
#define __pyx_kp_u_n_iter_1 __pyx_string_tab[2]
...
#define __pyx_kp_b_iso88591_a_wc_j_Bb_2Q_U_1_Bb_A_q_Ba_1 __pyx_string_tab[28]
...
/* Python wrapper */
static PyObject *__pyx_pw_12cy_integrate_1integrate_any(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_12cy_integrate_1integrate_any = {"integrate_any", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_12cy_integrate_1integrate_any, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_12cy_integrate_1integrate_any(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("integrate_any (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "integrate_any", 0) < (0)) __PYX_ERR(0, 6, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate_any", 0, 3, 4, i); __PYX_ERR(0, 6, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  4:
  ...
  __Pyx_RaiseArgtupleInvalid("integrate_any", 0, 3, 4, __pyx_nargs); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("cy_integrate.integrate_any", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_12cy_integrate_integrate_any(__pyx_self, __pyx_v_f, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_12cy_integrate_integrate_any(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_f, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  double __pyx_v_acc;
  double __pyx_v_step;
  int __pyx_v_i;
  double __pyx_v_x;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("integrate_any", 0);
...
*/
    ...
    __pyx_t_4 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_3, __pyx_mstate_global->__pyx_kp_u_n_iter_1};
 ...
 *     return acc
*/
    __pyx_t_2 = PyFloat_FromDouble(__pyx_v_acc); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_9 = NULL;
    ...
    __pyx_t_11 = PyNumber_Multiply(__pyx_t_3, __pyx_t_10); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    __pyx_t_10 = PyNumber_InPlaceAdd(__pyx_t_2, __pyx_t_11); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    __pyx_t_5 = __Pyx_PyFloat_AsDouble(__pyx_t_10); if (unlikely((__pyx_t_5 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
...
*/
  ...
  __pyx_t_10 = PyFloat_FromDouble(__pyx_v_acc); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_r = __pyx_t_10;
  __pyx_t_10 = 0;
  goto __pyx_L0;
...
static int __pyx_pymod_exec_cy_integrate(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cy_integrate},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_cy_integrate(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cy_integrate(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cy_integrate(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cy_integrate' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "cy_integrate" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_cy_integrate", 0);
  ...
  if (__pyx_module_is_main_cy_integrate) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cy_integrate")) {
      if (unlikely((PyDict_SetItemString(modules, "cy_integrate", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_12cy_integrate_1integrate_any, 0, __pyx_mstate_global->__pyx_n_u_integrate_any, NULL, __pyx_mstate_global->__pyx_n_u_cy_integrate, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_integrate_any, __pyx_t_2) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init cy_integrate", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init cy_integrate");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{16},{33},{20},{1},{3},{18},{1},{18},{12},{1},{8},{1},{13},{13},{5},{8},{10},{6},{8},{3},{12},{12},{10},{4},{8},{6},{1},{85}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (323 bytes) */
const char* const cstring = "BZh91AY&SY\211\223X\230\000\000\026\377\353\376]\251\000p10\003\264\001r\000\277\277\377\340PL@@'\013`@@\000@\0000\000\354!\0215\014\232=OH\006\201\240\000\006\2004\030L\200\333T9\246FC&\010h\302`\2154h\304\r2d`\000 \323Jh\304ORy\244@\323@\000\000\r\032d\362 \000V\360?\007u\001$J\260(C\234J\202\224\026\\\246\267\027\356\322@\355t\332\206\245\006\0250\032@\026\032\210\2662@\276\212\223\021\226|]\366\311Q\260\231\325\216\013\004x\221% )~'\370Y\233;\221\327Z\217\210\205\330\2076\001L'\352\363\355\265\361\3245\346!nAr\330\250\302\001:5\014\225\245E2-\343\007\005\211\201i\024\311Ar\226\024\343\231\270eY\3247\003\0028\307Z\201\200_\271>\231\320\220SjL'\242Z\234\2550\252\027\230\030\227\321\354!\321\006\274\347I\330i\023i\252\007\232\362\001\00633\363\211w\360\006\337\010\271\270\2603\214\030\345\013\216\365y\330\020\374K\211\t\304#H\210\244F7\243H\266f\024\376.\344\212p\241!\023&\2610";
...
const char* const cstring = "x\332MN\261J\304@\0205\232\203\240\242\034\202u\264\323\342 \366*\036\326\242\202\3650\331\333\223h\262\311ew5\351\016\253\005-\246\274\337\020\324F\364\0336]\312|\202\237\340B\344p`\230yo\036o\336)\253!\021\212\337\226\250\370\250\250+\001\211\342eh\337\354\267\375\264\037\366\335~\205\366\265yn\236\232\227\360\3448\214\000.\353\312\365y\302\024\\\360J]\363)\"c(k\301\222|\304\3622\327*\021\\\306,u\303\331\203*\221\361\030\331\375\377oS\200\251\026\014 YR\200\302\t$,=\\\226L\002d\350L\\e\371D\247\034\240\017\351&f\016\025y\0010\323\230\366\020@r\365wr\333\304\305\323\251\222\212;\225\342R\001<`\252\271\254\346^wp\330\372\273\204?\353+\203`\376h\030\r\333`\313\334-\274\305\260\3637\315\330\304\264FGt\325\371\201\031\230\033\332\243\250\rz~\225\366\351\254\r\266\315\214<\332\2411a\347o\230\350\027\\\231\211\210";
...
const char* const bytes = "?cy_integrate.pyxn_iter \320\264\320\276\320\273\320\266\320\265\320\275 \320\261\321\213\321\202\321\214 >= 1__Pyx_PyDict_NextRefaaccasyncio.coroutinesbcline_in_tracebackcy_integratef__func__iintegrate_any_is_coroutineitems__main____module__n_iter__name__pop__qualname____set_name__setdefaultstep__test__valuesx\200\001\340)*\330\004\026\220a\360\n\000\005\010\200w\210c\220\021\330\010\016\210j\230\001\230\021\340\004\014\210B\210b\220\003\2202\220Q\340\004\010\210\005\210U\220!\2201\330\010\014\210B\210b\220\002\220\"\220A\330\010\017\210q\220\001\220\023\220B\220a\340\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {4, 0, 0, 8, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 6};
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_cy_integrate_pyx, __pyx_mstate->__pyx_n_u_integrate_any, __pyx_mstate->__pyx_kp_b_iso88591_a_wc_j_Bb_2Q_U_1_Bb_A_q_Ba_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
